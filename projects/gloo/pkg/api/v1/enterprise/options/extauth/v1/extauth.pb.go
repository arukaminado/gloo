...
type OAuth struct {
	...
	// whether or not the access token will be provided to Gloo, or if Gloo should fetch instead using issuer.
	...
	ProvideAccessToken bool `protobuf:"varint,8,opt,name=provide_access_token,json=provideAccessToken,proto3" json:"provide_access_token,omitempty"`
	// the url for the access token introspection endpoint.
	// if provided, the (opaque) access token provided or received from the oauth endpoint
	// will be validated against this endpoint
	IntrospectionUrl string `protobuf:"bytes,9,opt,name=introspection_url,json=introspectionUrl,proto3" json:"introspection_url,omitempty"`
	// the url for the user info endpoint.
	// if provided, the (opaque) access token provided or received from the oauth endpoint
	// will be queried and the user info response will be put in the extauth filter metadata
	UserInfoUrl string `protobuf:"bytes,10,opt,name=user_info_url,json=userInfoUrl,proto3" json:"user_info_url,omitempty"`
	// how long the token introspection and/or user info endpoint response for a specific access token should be kept
	// in the in-memory cache. the introspection result will be invalidated at this timeout, or at "exp" time from the
	// introspection result, whichever comes sooner. if omitted, defaults to 10 minutes
	TokenIntrospectionCacheTimeout *time.Duration `protobuf:"bytes,11,opt,name=token_introspection_cache_timeout,json=tokenIntrospectionCacheTimeout,proto3,stdduration" json:"token_introspection_cache_timeout,omitempty"`
	XXX_NoUnkeyedLiteral           struct{}       `json:"-"`
	XXX_unrecognized               []byte         `json:"-"`
	XXX_sizecache                  int32          `json:"-"`
}
...
func (m *OAuth) GetProvideAccessToken() bool {
	if m != nil {
		return m.ProvideAccessToken
	}
	return false
}

func (m *OAuth) GetIntrospectionUrl() string {
	if m != nil {
		return m.IntrospectionUrl
	}
	return ""
}

func (m *OAuth) GetUserInfoUrl() string {
	if m != nil {
...
func (m *OAuth) GetTokenIntrospectionCacheTimeout() *time.Duration {
	if m != nil {
		return m.TokenIntrospectionCacheTimeout
	}
	return nil
}
...
func (*Ldap_ConnectionPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_043e68ecbb4b7f5e, []int{13, 0}
}
...
func (*ExtAuthConfig_OAuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_043e68ecbb4b7f5e, []int{14, 0}
}
...
func (*ExtAuthConfig_ApiKeyAuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_043e68ecbb4b7f5e, []int{14, 1}
}
...
func (*ExtAuthConfig_OpaAuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_043e68ecbb4b7f5e, []int{14, 2}
}
...
func (*ExtAuthConfig_Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_043e68ecbb4b7f5e, []int{14, 3}
}
...
var fileDescriptor_043e68ecbb4b7f5e = []byte{
	...
	,
}
...
func (this *OAuth) Equal(that interface{}) bool {
	...
	if this.ProvideAccessToken != that1.ProvideAccessToken {
		return false
	}
	...
	if this.TokenIntrospectionCacheTimeout != nil && that1.TokenIntrospectionCacheTimeout != nil {
		if *this.TokenIntrospectionCacheTimeout != *that1.TokenIntrospectionCacheTimeout {
			return false
		}
	} else if this.TokenIntrospectionCacheTimeout != nil {
		return false
	} else if that1.TokenIntrospectionCacheTimeout != nil {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false
